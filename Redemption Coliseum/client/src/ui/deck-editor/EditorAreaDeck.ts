...
export class EditorAreaDeck extends EditorArea {
  ...
  /**
   * Sets up mouse wheel handling for scrolling the deck list inside this area.
   */
  public setupWheelHandling() {
    this.graphics.on("wheel", (
      ...
      if (this.deckListView) {
        this.deckListView.scroll(pointer, deltaX, deltaY, 0, "Deck");
      }
    });
  }
}
